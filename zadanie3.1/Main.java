        ...
        for (int i = 0; i < figury.length(); i++) {
            ...
            switch (figura) {
                case "o":
                    ...
                    tablicaFigur.add(new Kolo(promien));
                ...
                case "p":
                    ...
                    tablicaFigur.add(new Pieciokat(bok));
                ...
                case "s":
                    ...
                    tablicaFigur.add(new Szesciokat(bok1));
                ...
                case "c":
                    ...
                    if (boki[0] == boki[1] && boki[2] == boki[3]) {
                        if (boki[0] == boki[3]) {
                            if (kat == 90) {
                                tablicaFigur.add(new Kwadrat(boki[0]));
                            }
                            else {
                                tablicaFigur.add(new Romb(boki[0], kat));
                            }
                        }
                        else if (kat == 90) {
                            tablicaFigur.add(new Prostokat(boki[0], boki[3]));
                        }
                        else {
